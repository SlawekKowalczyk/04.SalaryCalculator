...
public class SalaryCalculator extends JFrame implements ActionListener {
    ...
    private JLabel lGrossSalary;
    private JLabel lTaxYear;
    private JLabel lWorkplace;
    private JLabel lE;
    private JLabel lR;
    private JLabel lC;
    private JLabel lZ;
    private JLabel lZalPom;
    private JLabel lNettSalary;
    private JLabel lShowGrossSalary;
    private JLabel lShowE;
    private JLabel lShowR;
    private JLabel lShowC;
    private JLabel lShowZ;
    private JLabel lShowZalPom;
    private JLabel lShowNettSalary;
    private JLabel linformation2;
    private JMenu menuFile;
    private JMenu menuView;
    private JMenuItem mOpen, mSave, mExit,
            mMetal, mNimbus, mWindows,
            mAbout;
    private JTextField tBrutto;
    private JCheckBox ChYesNo;
    private BigDecimal brutto, netto, E, R, C, PNFZ, Z, ZP, Po, Zal, ZalPom, z1, KW, KUP;
    private double z2, z3, z4, z5;
    ...
    private void initButons() {
        ...
        JLabel linformation1 = new JLabel("Wskazówka: Możesz zapisać otrzymane wyniki obliczeń, np. do pliku *.txt.");
